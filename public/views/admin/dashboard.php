...
<head>
    ...
    <title>Адміністрування - Дашборд</title>
...
<div class="container mt-4">
    <div class="row">
        <div class="col-12">
            <h1 class="mb-4">Панель управління</h1>
        </div>
    </div>
    ...
    <div class="row">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h2 class="mb-0"><?= $stats['products_count'] ?? 0 ?></h2>
                        </div>
                        <i class="fas fa-laptop fa-3x"></i>
                    </div>
                </div>
                <div class="card-footer">
                    <a href="admin.php?action=products" class="text-primary">Управління товарами</a>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h2 class="mb-0"><?= $stats['orders_count'] ?? 0 ?></h2>
                        </div>
                        <i class="fas fa-shopping-cart fa-3x"></i>
                    </div>
                </div>
                <div class="card-footer">
                    <a href="admin.php?action=orders" class="text-success">Управління замовленнями</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3 mb-4">
            <div class="card stats-card bg-info text-white">
                ...
                <div class="card-footer">
                    <a href="admin.php?action=customers" class="text-info">Управління клієнтами</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3 mb-4">
            <div class="card stats-card bg-warning text-white">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h5 class="card-title">Ігри</h5>
                            <h2 class="mb-0"><?= $stats['games_count'] ?? 0 ?></h2>
                        </div>
                        <i class="fas fa-gamepad fa-3x"></i>
                    </div>
                </div>
                <div class="card-footer">
                    <a href="admin.php?action=games" class="text-warning">Управління іграми</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-6 mb-4">
            <div class="card main-card shadow-sm">
                ...
                <div class="card-footer">
                    <a href="admin.php?action=orders" class="btn btn-sm btn-primary">Всі замовлення</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6 mb-4">
            <div class="card main-card shadow-sm">
                <div class="card-header">
                    <h5 class="mb-0">Найпопулярніші товари</h5>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped">
